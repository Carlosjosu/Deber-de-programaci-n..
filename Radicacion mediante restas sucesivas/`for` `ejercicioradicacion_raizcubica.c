...
int main() {
    ...
    int i; // Ira incrementando conforme se repita el bucle
    ...
    for (i = 0; result * result * result <= n1; ) {
        /* Se comprueba si result * result * result (cubo del resdulatdo) es menor o igaul que n1
