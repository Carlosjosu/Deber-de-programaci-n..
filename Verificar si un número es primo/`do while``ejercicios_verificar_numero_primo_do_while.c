...
int main()
{
    ...
    /* Se ejecuta 'do while' el cual iteracciona desde 2 hasta la mitad del numero ingresado y verifica si es divible
    ...
    do
    {
        ...
        i++; // Incrementa el divisor para siguiente iteraccion

    } while (i <= n1 / 2 && es_primo);
